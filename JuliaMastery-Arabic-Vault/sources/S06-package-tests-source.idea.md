...
الاختبارات هنا تقرأ الحزمة كمستخدم خارجي. استعملها لفهم العقد المقصود، والأنواع المدعومة، والحواف، ونقاط التوسعة.

## أسئلة توجه القراءة

1. أي اختبار يثبت أن Midpoint امتداد حقيقي من خارج الحزمة؟
2. أين يُختبر النوع `Float32`؟
3. كيف يُختبر فشل CG المقصود؟
