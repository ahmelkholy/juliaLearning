...
tags:
  - source/code
  - julia
source: scripts/learning_coach.jl
...
هذا السكربت مثال تطبيقي على module، وTOML، وCLI، وتشغيل processes، وحفظ حالة صغيرة. اقرأه بعد الدروس الأساسية لا قبلها.

## أسئلة توجه القراءة

1. كيف يحدد السكربت جذر المشروع؟
2. كيف يمنع احتساب نقاط السؤال نفسه مرتين؟
3. لماذا يشغّل الدرس في process منفصلة؟
...
- [[00-start-here.idea|00 - ابدأ هنا]]
